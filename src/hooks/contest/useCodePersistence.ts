...
export function useCodePersistence({ contestId, problemId }: UseCodePersistenceParams): UseCodePersistenceReturn {
    ...
    useEffect(() => {
        ...
        loadData();
    }, [contestId, problemId, dbProblemId, storageKeyCode, storageKeyLang, isAuthenticated, authLoading]);
    ...
    }, [code, language, contestId, problemId, dbProblemId, isLoaded, isAuthenticated, authLoading, storageKeyCode, storageKeyLang]);
