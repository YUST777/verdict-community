...
function HeroSection() {
    ...
    const parseCodeforcesUrl = (url: string) => {
        ...
        // 1. Group Problem (MUST BE FIRST - most specific pattern)
        ...
        // 6. Group Generic (includes /submit, /standings, root)
        ...
        // 7. Contest Generic (includes /submit, /standings, root)
