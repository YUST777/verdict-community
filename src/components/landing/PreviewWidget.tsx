        ...
        <section className="relative z-10 py-12 md:py-20 px-4 md:px-6 md:-mt-32">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mt-8 md:mt-12">
                    <div className="flex flex-row items-stretch justify-center gap-2 sm:gap-4 px-2 sm:px-0">
                        <Link
                            href="/contest/1/problem/A"
                            className="flex-1 sm:flex-none sm:w-auto inline-flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-6 py-3 bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-[13px] sm:text-base rounded-xl transition-all hover:scale-105"
                        >
