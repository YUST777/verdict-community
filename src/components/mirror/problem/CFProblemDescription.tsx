...
export const CFProblemDescription = React.memo(function CFProblemDescription({ data }: { data: CFProblemData | null }) {
    ...
    return (
        <div className="prose prose-invert max-w-none text-white/90 selection:bg-[#10B981]/30">
            {/* Configure MathJax for the safer \(\) and \[\] delimiters generated by the scraper */}
            <Script
                id="mathjax-config"
            ...
            <style jsx global>{`
                ...
                /* MathJax specific overrides for dark mode visibility and layout stability */
                mjx-container { 
                ...
                /* Prevent prose from adding extra gaps to math blocks */
                .prose mjx-container p { margin: 0 !important; }
            `}</style>
