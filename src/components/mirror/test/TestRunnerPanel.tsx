                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-32 bg-[#1a1a1a] border border-white/10 rounded-lg p-3 text-sm font-mono text-[#d4d4d4] placeholder-[#555] focus:outline-none focus:border-[#10B981]/50 resize-none custom-scrollbar"
                                    />
                                </div>
                                <div>
                                    <label className="text-xs font-medium text-[#888] mb-2 block uppercase tracking-wider">
