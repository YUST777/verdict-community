...
const HeroHeader = () => {
    ...
    const authHref = isAuthenticated ? '/dashboard' : '/register'
    const authLabel = isAuthenticated === null ? '...' : isAuthenticated ? 'Dashboard' : 'Login'
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/50 max-w-4xl rounded-2xl border border-white/[0.03] backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                ...
                                <Link
                                    href={authHref}
                                    className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-white font-semibold bg-emerald-500/90 hover:bg-emerald-400 transition-all border border-emerald-300/40"
                                >
                                    <span className="text-sm tracking-wide">{authLabel}</span>
